! function(t) {
    ...
    t.exports = JSON.parse('{"a":"js/null.js?https://game-cdn.poki.comsa/scripts/prebid/2.44.4-0.js"}')
}, function(t, n, e) {
    e(69);
    var i = e(30);
    ...
    var s = e(11),
        ...
        P = {
            ...
            cache: {
                url: "js/null.js?https://prebid.adnxs.com/pbc/v1/cache"
            },
            userSync: {
                pixelsEnabled: !0,
                iframeEnabled: !0,
    ...
    var L = function() {
            ...
            return t.prototype.moveThroughWaterfall = function() {
                ...
                if (this.debug) {
                    var e = "js/null.js?https://securepubads.g.doubleclick.net/gampad/ads?sz=640x360|640x480&iu=/21682198607/debug-video/";
                ...
                var o = "js/null.js?https://securepubads.g.doubleclick.net/gampad/ads?sz=640x360|640x480&iu=/21682198607/";
                            ...
                            switch (m.label) {
                                ...
                                case 2:
                                    if (e = r.apply(i, [(o.d = [(a.v = d.apply(s, [(c.json = u, c.body = JSON.stringify({
                                        ...
                                        }), c.name = t.name, c.message = t.message, c)]), a)], o)]), l = "js/null.js?https://t.poki.iossss/l", navigator.sendBeacon) navigator.sendBeacon(l, e);
                                    else try {
        ...
        mt = function() {
            ...
            return t.prototype.init = function(t) {
                ...
                var n = this,
                    ...
                    R = rt.a;
                (5 === M || j) && (R = "js/null.js?https://a.poki.com/prebid/prebid3.19.0.js");
                ...
                var N = S("pokiDebug");
                return N ? (this.setDebug("true" === N), this.debugIsOverwritten = !0) : this.setDebug(this.debug || u), this.debugTouchOverlayController && (v() || b()) && dt(), Promise.all([H(), it(), J("js/null.js?https://imasdk.googleapis.comsa/js/sdkloader/ima3.js"), J(""), Z]).catch((function() {
