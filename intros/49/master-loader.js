...
if (!window.config.unityWebglLoaderUrl) {
    ...
    switch (year) {
        case "2019":
            window.config.unityWebglLoaderUrl = 1 === minor ? "UnityLoader.2019.1.js" : "https://game-cdn.poki.com/loaders/v2/unity/static/UnityLoader.2019.2.js";
            break;
        default:
...
sdkScript.src = "./poki.js", sdkScript.onload = function() {
